...
export const ServicesHome = () => {
  ...
  return (
    <div className="w-full mx-auto">
      ...
      <section className="bg-gradient-to-r from-emerald-500 to-teal-500 text-rose-50 p-12 rounded-lg shadow-lg mx-6 md:mx-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-8">
          <div className="p-6 bg-white/20 rounded-lg shadow-md text-center">
            ...
            <p className="text-rose-50/90">Servicios verificados para garantizar tu satisfacción.</p>
          </div>
          <div className="p-6 bg-white/20 rounded-lg shadow-md text-center">
            <h3 className="text-lg font-bold">💬 Soporte 24/7</h3>
            <p className="text-rose-50/90">Siempre disponibles para ayudarte.</p>
          </div>
          <div className="p-6 bg-white/20 rounded-lg shadow-md text-center">
            <h3 className="text-lg font-bold">💲 Precios Competitivos</h3>
            <p className="text-rose-50/90">La mejor calidad al mejor precio.</p>
          </div>
        </div>
      </section>
